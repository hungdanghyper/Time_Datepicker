package com.example.dangb.time_datepicker;
...
import android.widget.Toast;
 class MainActivity extends Activity {
    ...
    ArrayList<datetime>arrJob=new ArrayList<datetime>();
    //Khai báo ArrayAdapter cho ListView
    ArrayAdapter<datetime>adapter=null;
    ListView lvCv;
    Calendar cal;
    Date dateFinish;
    Date hourFinish;
    ...
    public void getFormWidgets()
    {
        ...
        adapter=new ArrayAdapter<datetime>
                (this,
    ...
    public void processAddJob()
    {
        ...
        datetime job=new datetime(title, description, dateFinish, hourFinish);
        arrJob.add(job);
        adapter.notifyDataSetChanged();
